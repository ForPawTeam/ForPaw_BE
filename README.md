...
| 이한홍  | BE/PL | <ul><li>REST API 및 DB 설계</li><li>주요 API 개발</li><li>공공 데이터 API를 활용한 유기 동물 데이터 수집 및 처리 구현</li><li>JWT와 OAuth 2.0을 활용한 Google, Kakao 소셜 로그인 및 인증 기능 구현</li><li>FastAPI와 OpenAI API를 활용한 유기 동물 소개글 자동 생성 로직 구현</li><li>RabbitMQ를 활용한 실시간 단체 채팅 기능 구현</li><li>AWS EC2 배포 및 Jenkins를 활용한 CI/CD 파이프라인 구축</li><li>관리자 페이지 UI/UX 디자인</li></ul> |
